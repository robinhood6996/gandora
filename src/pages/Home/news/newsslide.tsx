...
const NewsSlide = () => {
  const slideClass = {
    contain:
      "mx-auto w-[calc(100%-40px)] md:w-[calc(100%-220px)] max-w-1000 font-Rajdhani",
    title:
      "uppercase py-5p sm:text-34  text-16 text-Dajdhani text-davygrey font-bold text-montserrat",
    description:
      "px-220p text-center text-avenir mb-10p text-18p text-roadDetail",
  };
  ...
  return (
    <div className={slideClass.contain} id="newsSlide">
      ...
      <p className="uppercase sm:text-21 text-12 sm:leading-26 tracking-10p font-semibold text-davygrey py-5p">
        <FontAwesomeIcon
          icon={faAngleRight}
          className="mr-10p text-texasRose"
        ></FontAwesomeIcon>
        most play
      </p>
      <div className="pb-10p hidden md:block mobile__slider">
      ...
      <div className="pb-30p hidden md:block  mobile__slider">
        <Carousel responsive={responsive} infinite autoPlay>
