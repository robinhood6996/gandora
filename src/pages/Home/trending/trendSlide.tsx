...
const TrendSlide = () => {
  const slideClass = {
    contain:
      "md:mx-auto max-w-1000 sm:py-100 pb-70 pt-15 bg-davygrey bg-opacity-[2%] px-20",
    title:
      "uppercase my-5p sm:text-34 text-16 text-Dajdhani text-davygrey font-bold text-montserrat",
  };
  ...
  return (
    <div className={slideClass.contain} id="newsSlide">
      ...
      <p className={slideClass.title}>
        Trending in <span className="text-seletiveyellow">all categories</span>
      </p>
