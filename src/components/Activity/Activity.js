            ...
            <div className='container mx-auto mt-50 '>
                ...
                <div className="bg-backg">
                    ...
                    <div className="flex justify-center flex-column">
                        <div className="mx-100 md:mx-none filter-options flex justify-between pt-20">
                            <div className="float-left flex gap-20">
                                <div className="py-2 ">
                                    <select className="border-base py-2 px-5">
                                        <option className="py-4" value="">LAST 7 DAYS</option>
                                        <option className="py-4" value="">LAST 14 DAYS</option>
                                        <option className="py-4" value="">LAST 30 DAYS</option>
                                        <option className="py-4" value="">LAST 60 DAYS</option>
                                        <option className="py-4" value="">ALL TIME</option>
                                    </select>
                                </div>
