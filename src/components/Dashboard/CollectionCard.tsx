...
const CollectionCard = () => {
    return (
        <Link to='/dashboard/collection/1' className='w-full card-box-shadow border-[0.5px] border-borderdefault flex flex-col rounded-tl-[10px] rounded-tr-[10px]  rounded-bl-[40px] rounded-br-[40px] font-lato'>
