            ...
            <div className='container mx-auto mt-50 '>
                ...
                <div className="filter-buttons-group mx-100 mb-30">
                    <div className="filter-buttons">
                        <Slider {...settings}>
                            <div>
                                <div className="flex gap-2 py-2 rounded-2 my-auto border-10 border-base">
                            ...
                            <div>
                                <div className="flex gap-2 py-2 rounded-2 my-auto border-10 border-base bg-active text-white">
